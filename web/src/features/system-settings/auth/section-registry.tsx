    ...
    build: (settings: AuthSettings) => (
      <OAuthSection
        ...
        defaultValues={{
          ...
          TelegramChannelBonusEnabled: settings.TelegramChannelBonusEnabled,
          TelegramChannelBonusChannel: settings.TelegramChannelBonusChannel,
          TelegramChannelBonusAmountUSD: settings.TelegramChannelBonusAmountUSD,
